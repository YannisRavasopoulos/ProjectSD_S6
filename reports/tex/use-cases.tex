...
\begin{enumerate}
    \item[1] Ο Carpooler επιλέγει να δει τις πληροφορίες του αιτήματος Pickup.
    \item[2] Η εφαρμογή εμφανίζει τις λεπτομέριες της αίτησης.
    \item[3] Ο Carpooler επιλέγει "Accept".
    \item[4] Η εφαρμογή εμφανίζει μήνυμα αποδοχής στον Carpooler.
\end{enumerate}

\subsubsection{Εναλλακτική Ροή: Απόρριψη}

\begin{enumerate}
   \item[3] Ο Carpooler επιλέγει "Reject".
   \item[4] Η εφαρμογή εμφανίζει μήνυμα απόρριψης στον Carpooler.
\end{enumerate}
